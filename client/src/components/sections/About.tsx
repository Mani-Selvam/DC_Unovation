        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              At DC Unovation, we're passionate about creating exceptional digital experiences.
              Our team of expert developers, designers, and strategists work together to bring
              your vision to life with innovative solutions that drive results.
            </p>

            <p className="text-lg text-muted-foreground leading-relaxed">
              From startups to enterprises, we've helped businesses across the globe transform
              their digital presence and achieve their goals through cutting-edge technology
            ...
            <div className="pt-6 space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Be the leading force in digital transformation, making technology accessible to all.
                  </p>
                </div>
              </div>
            </div>
